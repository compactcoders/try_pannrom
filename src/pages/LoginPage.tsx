...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-[80vh] grid place-items-center px-4 fade-in-up parallax-medium">
      <div className="w-full max-w-md">
        {/* Floating card with glassmorphism */}
        <div className="rounded-3xl bg-gradient-to-br from-slate-900/90 to-slate-800/70 backdrop-blur-xl border border-cyan-500/30 p-8 shadow-2xl shadow-cyan-500/20 relative overflow-hidden neon-border hover:glow-cyan transition-all duration-500 float circuit-pattern interactive-glow wave-animation magnetic-field hover-lift breathing">
          {/* Animated background gradient */}
          <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/10 via-purple-500/5 to-pink-500/5 animate-pulse hologram energy-field" />
          ...
          <div className="relative z-10">
            <div className="text-center mb-8">
              <div className="w-20 h-20 bg-gradient-to-br from-cyan-400 via-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-2xl hover:scale-110 transition-transform duration-300 hologram pulse-glow breathing energy-ripple">
                <span className="text-white font-black text-3xl font-mono">P</span>
              </div>
              <h2 className="text-4xl font-black bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent mb-3 font-mono tracking-wider glitch" data-text="WELCOME.BACK">
                WELCOME.BACK
              </h2>
              <p className="text-slate-400 text-sm font-mono tracking-widest">SIGN.IN.TO.YOUR.KNOWLEDGE.UNIVERSE</p>
            </div>
            
            <div className="bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rounded-xl p-4 mb-6 border border-cyan-500/30 neon-border pulse-glow wave-animation magnetic">
            ...
            <Tabs defaultValue="personal" className="w-full">
              <TabsList className="grid w-full grid-cols-2 bg-slate-900/50 border border-white/20 p-1 rounded-xl magnetic">
                <TabsTrigger value="personal" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-cyan-500 data-[state=active]:to-purple-600 data-[state=active]:text-white flex items-center space-x-2 font-mono font-bold tracking-wider hover:scale-105 transition-all duration-300 magnetic energy-ripple">
                  <User className="w-4 h-4" />
                  <span>PERSONAL</span>
                </TabsTrigger>
                <TabsTrigger value="organization" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-purple-500 data-[state=active]:to-pink-600 data-[state=active]:text-white flex items-center space-x-2 font-mono font-bold tracking-wider hover:scale-105 transition-all duration-300 magnetic energy-ripple">

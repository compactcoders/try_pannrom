  ...
  return (
    <div className="min-h-[80vh] grid place-items-center px-4 fade-in-up parallax-medium">
      <div className="w-full max-w-md">
        <div className="rounded-3xl bg-gradient-to-br from-slate-900/90 to-slate-800/70 backdrop-blur-xl border border-purple-500/30 p-8 shadow-2xl shadow-purple-500/20 relative overflow-hidden neon-border hover:glow-purple transition-all duration-500 float circuit-pattern interactive-glow wave-animation magnetic-field hover-lift breathing">
          {/* Animated background */}
          <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 via-pink-500/5 to-cyan-500/5 animate-pulse hologram energy-field" />
          ...
          <div className="relative z-10">
            <div className="text-center mb-8">
              <div className="w-20 h-20 bg-gradient-to-br from-purple-400 via-pink-500 to-cyan-400 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-2xl hover:scale-110 transition-transform duration-300 hologram pulse-glow breathing energy-ripple">
                <UserPlus className="w-10 h-10 text-white" />
              </div>
              <h2 className="text-4xl font-black bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent mb-3 font-mono tracking-wider glitch" data-text="JOIN.PANDA">
                JOIN.PANDA
              </h2>

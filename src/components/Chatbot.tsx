    ...
    <Card className="flex flex-col h-[700px] bg-gradient-to-br from-slate-900/90 to-slate-800/50 backdrop-blur-xl border border-cyan-500/30 shadow-2xl overflow-hidden relative neon-border hover:glow-cyan transition-all duration-500 group fade-in-up interactive-glow wave-animation magnetic-field hover-lift">
      ...
      <CardHeader className="scan-line parallax-slow">
        <CardTitle className="flex items-center gap-3 text-xl font-bold text-white relative z-10 group-hover:text-cyan-300 transition-colors duration-300">
          <div className="w-12 h-12 bg-gradient-to-br from-cyan-400 to-purple-600 rounded-xl flex items-center justify-center relative overflow-hidden group-hover:scale-110 transition-transform duration-300 hologram breathing energy-ripple">
      ...
      <CardContent className="flex-grow space-y-4 relative z-10 parallax-medium">
        ...
        <div className="space-y-3 p-4 rounded-xl bg-slate-900/60 border border-cyan-500/20 neon-border hover:glow-cyan transition-all duration-300 data-stream wave-animation magnetic">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="flex space-x-2">
              ...
              <Button 
                ...
                size="sm"
                className="bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-400 hover:to-cyan-500 text-white border border-cyan-500/30 px-4 font-mono font-bold hover:scale-105 transition-all duration-300 hover:glow-cyan magnetic energy-ripple"
              >
                SET
              </Button>
            </div>
            ...
            <div className="flex space-x-2">
              ...
              <Button 
                ...
                size="sm"
                className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-400 hover:to-purple-500 text-white border border-purple-500/30 px-4 font-mono font-bold hover:scale-105 transition-all duration-300 hover:glow-purple magnetic energy-ripple"
              >
                SET
              </Button>
            </div>
            ...
            <div className="flex space-x-2">
              ...
              <Button 
                ...
                size="sm"
                className="bg-gradient-to-r from-pink-500 to-pink-600 hover:from-pink-400 hover:to-pink-500 text-white border border-pink-500/30 px-4 font-mono font-bold hover:scale-105 transition-all duration-300 hover:glow-pink magnetic energy-ripple"
              >
                SET
              </Button>
            </div>
          ...
          <div className="space-y-4">
            {messages.length === 0 && (
              <div className="text-center py-8">
                <div className="w-16 h-16 bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-xl flex items-center justify-center mx-auto mb-4 float hologram breathing energy-ripple">
            ...
            {messages.map((msg, i) => (
              <div key={i} className={`flex items-start space-x-3 ${msg.sender === 'user' ? 'flex-row-reverse space-x-reverse' : ''} fade-in-up wave-animation`}>
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 relative overflow-hidden hover:scale-110 transition-transform duration-300 hologram breathing energy-ripple ${
                  msg.sender === 'user' 
                ...
                <div className={`px-4 py-3 rounded-2xl max-w-[80%] shadow-2xl border transition-all duration-300 hover:scale-[1.02] font-mono magnetic ${
                  msg.sender === 'user' 
      ...
      {/* Chat Input */}
      <div className="p-6 border-t border-cyan-500/20 relative z-10 bg-gradient-to-r from-slate-900/50 to-slate-800/30 backdrop-blur-sm wave-animation">
        <div className="flex space-x-3">
          <div className="relative flex-1">
            ...
            <Input 
              ...
              className="pl-11 bg-slate-900/50 border-cyan-500/30 text-white placeholder:text-slate-500 focus:border-cyan-400 focus:glow-cyan py-4 font-mono tracking-wide transition-all duration-300 hover:bg-slate-800/50 magnetic"
            />
          </div>
          <Button 
            onClick={handleSend}
            className="bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-400 hover:to-purple-500 text-white font-mono font-bold px-6 py-4 rounded-xl shadow-2xl border border-cyan-500/30 flex items-center space-x-2 hover:scale-105 hover:glow-cyan transition-all duration-300 relative overflow-hidden group magnetic energy-ripple"
          >
